    ...
    def iniciarJogada(self):
        ...
        if self.Jogador1.turno == True:  # Iniciar jogada
            ...
            if codigoVencedor != 404:  # Escolher campo
                self.marcarVencedorBatalha(self.campoDeJogo.posicoesOcupadas[self.Jogador1.campoSelecionado],
                                           self.Jogador1.campoSelecionado)  # Escolher campo - Verificar batalha
            ...
            if codigoVencedor != 404:
                self.marcarVencedorBatalha(self.campoDeJogo.posicoesOcupadas[self.Jogador2.campoSelecionado],
                                           self.Jogador2.campoSelecionado)
