...
class Ui_ElementPo(object):
    ...
    def marcarVitoriaBatalha(self, jogador, posCampo):
        ...
        if jogador == 1:
            resultLabelGroup[posCampo].setText(self._translate(resultLabelGroup[posCampo].text(), "J1"))
            resultLabelGroup[posCampo].show()
        else:
            resultLabelGroup[posCampo].setText(self._translate(resultLabelGroup[posCampo].text(), "J2"))
            resultLabelGroup[posCampo].show()
